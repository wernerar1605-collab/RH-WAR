...
const mockEmployeesForLeave: Employee[] = [
    { id: 1, name: 'Rosa Maia', role: 'Desenvolvedora Frontend', department: 'Tecnologia', email: 'rosa.maia@example.com', avatar: 'https://i.pravatar.cc/150?u=rosa', status: 'Ativo', dataDeAdmissao: '2022-03-15', cpf: '111.111.111-11', rg: '11.111.111-1', dataDeNascimento: '1990-05-10', telefone: '(11) 98888-7777', regimeDeTrabalho: 'CLT' },
    { id: 2, name: 'Rafael Salgado', role: 'Designer UX/UI', department: 'Produto', email: 'rafael.salgado@example.com', avatar: 'https://i.pravatar.cc/150?u=rafael', status: 'Ativo', dataDeAdmissao: '2021-11-20', cpf: '222.222.222-22', rg: '22.222.222-2', dataDeNascimento: '1992-08-25', telefone: '(11) 97777-6666', regimeDeTrabalho: 'CLT' },
    { id: 3, name: 'João Ricardo', role: 'Gerente de Projetos', department: 'Tecnologia', email: 'joao.ricardo@example.com', avatar: 'https://i.pravatar.cc/150?u=joao', status: 'Ativo', dataDeAdmissao: '2020-01-10', cpf: '333.333.333-33', rg: '33.333.333-3', dataDeNascimento: '1988-02-14', telefone: '(11) 96666-5555', regimeDeTrabalho: 'PJ' },
    { id: 4, name: 'Mariana Silva', role: 'Engenheira de Dados', department: 'Dados', email: 'mariana.silva@example.com', avatar: 'https://i.pravatar.cc/150?u=mariana', status: 'Ativo', dataDeAdmissao: '2023-05-01', cpf: '444.444.444-44', rg: '44.444.444-4', dataDeNascimento: '1995-12-01', telefone: '(11) 95555-4444', regimeDeTrabalho: 'CLT' },
    { id: 5, name: 'Lorena Dias', role: 'Analista de RH', department: 'RH', email: 'lorena.dias@example.com', avatar: 'https://i.pravatar.cc/150?u=lorena', status: 'Ativo', dataDeAdmissao: '2022-09-05', cpf: '555.555.555-55', rg: '55.555.555-5', dataDeNascimento: '1993-07-30', telefone: '(11) 94444-3333', regimeDeTrabalho: 'CLT' },
    { id: 6, name: 'Silvia Albuquerque', role: 'Desenvolvedora Backend', department: 'Tecnologia', email: 'silvia.albuquerque@example.com', avatar: 'https://i.pravatar.cc/150?u=silvia', status: 'Ativo', dataDeAdmissao: '2022-01-20', cpf: '666.666.666-66', rg: '66.666.666-6', dataDeNascimento: '1991-03-20', telefone: '(11) 93333-2222', regimeDeTrabalho: 'CLT' },
    { id: 7, name: 'Tomas Guimarães', role: 'Analista de Marketing', department: 'Marketing', email: 'tomas.guimaraes@example.com', avatar: 'https://i.pravatar.cc/150?u=tomas', status: 'Ativo', dataDeAdmissao: '2023-02-10', cpf: '777.777.777-77', rg: '77.777.777-7', dataDeNascimento: '1996-01-15', telefone: '(11) 92222-1111', regimeDeTrabalho: 'CLT' },
    { id: 8, name: 'Marina Avelar', role: 'Product Manager', department: 'Produto', email: 'marina.avelar@example.com', avatar: 'https://i.pravatar.cc/150?u=marina', status: 'Ativo', dataDeAdmissao: '2021-07-15', cpf: '888.888.888-88', rg: '88.888.888-8', dataDeNascimento: '1989-11-05', telefone: '(11) 91111-0000', regimeDeTrabalho: 'PJ' },
    { id: 9, name: 'Joana Medeiros', role: 'Analista Financeiro', department: 'Financeiro', email: 'joana.medeiros@example.com', avatar: 'https://i.pravatar.cc/150?u=joana', status: 'Ativo', dataDeAdmissao: '2022-11-01', cpf: '999.999.999-99', rg: '99.999.999-9', dataDeNascimento: '1994-06-22', telefone: '(11) 99999-8888', regimeDeTrabalho: 'CLT' },
    { id: 10, name: 'Ricardo Amorim', role: 'Desenvolvedor Full-Stack', department: 'Tecnologia', email: 'ricardo.amorim@example.com', avatar: 'https://i.pravatar.cc/150?u=ricardo', status: 'Ativo', dataDeAdmissao: '2020-05-25', cpf: '101.010.101-01', rg: '10.101.010-1', dataDeNascimento: '1987-09-12', telefone: '(11) 98888-7777', regimeDeTrabalho: 'CLT' },
    { id: 11, name: 'Pedro Braga', role: 'Estagiário de Design', department: 'Produto', email: 'pedro.braga@example.com', avatar: 'https://i.pravatar.cc/150?u=pedro', status: 'Ativo', dataDeAdmissao: '2024-02-01', cpf: '121.212.121-21', rg: '12.121.212-1', dataDeNascimento: '2000-04-18', telefone: '(11) 97777-6666', regimeDeTrabalho: 'Estágio' },
    { id: 12, name: 'Ana Maria Santos', role: 'Recrutadora', department: 'RH', email: 'ana.santos@example.com', avatar: 'https://i.pravatar.cc/150?u=ana', status: 'Ativo', dataDeAdmissao: '2021-09-18', cpf: '131.313.131-31', rg: '13.131.313-1', dataDeNascimento: '1992-10-03', telefone: '(11) 96666-5555', regimeDeTrabalho: 'CLT' },
    { id: 13, name: 'Raquel Bouças', role: 'Engenheira de Software', department: 'Tecnologia', email: 'raquel.boucas@example.com', avatar: 'https://i.pravatar.cc/150?u=raquel', status: 'Ativo', dataDeAdmissao: '2022-06-30', cpf: '141.414.141-41', rg: '14.141.414-1', dataDeNascimento: '1993-08-28', telefone: '(11) 95555-4444', regimeDeTrabalho: 'CLT' },
];

// Helper to generate dynamic dates for mock data
...
const mockLeaveRequests: LeaveRequest[] = [
    { id: 1, employee: mockEmployeesForLeave[0], type: 'Férias', startDate: getDate(1), endDate: getDate(8), status: 'Aprovada' },
    { id: 2, employee: mockEmployeesForLeave[1], type: 'Viagem de Trabalho', startDate: getDate(14), endDate: getDate(17), status: 'Aprovada' },
    { id: 3, employee: mockEmployeesForLeave[2], type: 'Home Office', startDate: getDate(7), endDate: getDate(10), status: 'Aprovada' },
    { id: 4, employee: mockEmployeesForLeave[3], type: 'Férias', startDate: getDate(7), endDate: getDate(14), status: 'Aprovada' },
    { id: 5, employee: mockEmployeesForLeave[4], type: 'Licença médica', startDate: getDate(16), endDate: getDate(20), status: 'Aprovada' },
    { id: 6, employee: mockEmployeesForLeave[5], type: 'Viagem de Trabalho', startDate: getDate(8), endDate: getDate(14), status: 'Aprovada' },
    { id: 7, employee: mockEmployeesForLeave[6], type: 'Férias', startDate: getDate(2), endDate: getDate(9), status: 'Aprovada' },
    { id: 8, employee: mockEmployeesForLeave[7], type: 'Férias', startDate: getDate(14), endDate: getDate(18), status: 'Aprovada' },
    { id: 9, employee: mockEmployeesForLeave[8], type: 'Licença médica', startDate: getDate(2), endDate: getDate(6), status: 'Aprovada' },
    { id: 10, employee: mockEmployeesForLeave[9], type: 'Home Office', startDate: getDate(9), endDate: getDate(15), status: 'Aprovada' },
    { id: 11, employee: mockEmployeesForLeave[10], type: 'Férias', startDate: getDate(2), endDate: getDate(9), status: 'Aprovada' },
    { id: 12, employee: mockEmployeesForLeave[11], type: 'Viagem de Trabalho', startDate: getDate(8), endDate: getDate(14), status: 'Aprovada' },
    { id: 13, employee: mockEmployeesForLeave[12], type: 'Viagem de Trabalho', startDate: getDate(1), endDate: getDate(4), status: 'Aprovada' },
    { id: 14, employee: mockEmployeesForLeave[12], type: 'Férias', startDate: getDate(14), endDate: getDate(17), status: 'Aprovada' },
    { id: 15, employee: mockEmployeesForLeave[1], type: 'Férias', startDate: getDate(2, 1), endDate: getDate(6, 1), status: 'Pendente' }, // Next month
];

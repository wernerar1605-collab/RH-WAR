...
const mockCandidates: Candidate[] = [
  { id: 1, name: 'Fernando Lima', jobId: 1, stageId: 4, resumeSummary: '', avatar: 'https://picsum.photos/seed/6/200' },
  { id: 2, name: 'Gabriela Mendes', jobId: 1, stageId: 1, resumeSummary: '', avatar: 'https://picsum.photos/seed/7/200' },
  { id: 3, name: 'Heloísa Pinto', jobId: 2, stageId: 5, resumeSummary: '', avatar: 'https://picsum.photos/seed/8/200' },
  { id: 4, name: 'Ivan Gomes', jobId: 1, stageId: 2, resumeSummary: '', avatar: 'https://picsum.photos/seed/9/200' },
  { id: 5, name: 'Juliana Alves', jobId: 2, stageId: 2, resumeSummary: '', avatar: 'https://picsum.photos/seed/10/200' },
  { id: 6, name: 'Kleber Souza', jobId: 1, stageId: 1, resumeSummary: '', avatar: 'https://picsum.photos/seed/11/200' },
  { id: 7, name: 'Lívia Andrade', jobId: 2, stageId: 3, resumeSummary: '', avatar: 'https://picsum.photos/seed/12/200' },
];
